                ...
                <table className="w-full text-left text-sm rtl:text-right text-gray-500 dark:text-gray-400">
                  <thead className="text-xs text-gray-700 uppercase">
                    <tr className="text-nowrap bg-gray-100">
                      ...
                      <th className="px-3 py-2"> COSTO ORE</th>
                      <th className="px-3 py-2"> COSTO MATERIALI</th>
                    </tr>
                  </thead>
                  <tbody>
                    {tasks.data.map((task) => (
                    ...
                    <tr>
                      <th className="px-3 py-2">PREZZO TOTALE </th>
                      <td className="px-3 py-2"></td>
                      <td className="px-3 py-2"></td>
                      <td className="px-3 py-2"></td>
                      <td className="px-3 py-2">{materialsTot+hoursCostTot}</td>
                    </tr>
                  ...
                  <tbody>
                    {detailmaterial.data.map((material) => (
                      ...
                      >
                        ...
                        <td className="px-3 py-2">{(material.priece * material.default_aug / 100) + (material.priece * material.custom_aug / 100) +  parseFloat (material.priece )  }</td>
