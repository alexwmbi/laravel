...
export default function Taskfromworker({ auth, client, works, worker, queryParams }) {
        ...
        <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
          <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
            ...
            >
              ...
              <div className="mt-4">
                <InputLabel htmlFor="hours" value="Ore Operaio " />

                <TextInput
                  id="hours"
                  type="text"
                  name="hours"
                  value={queryParams.hours}
                  className="mt-1 block w-full"
                  isFocused={true}
                  onChange={(e) => setData("queryParamshours", e.target.value)}
                />
              ...
              <div className="mt-4">
                <InputLabel htmlFor="task_name" value="Nome Lavorazione " />
              ...
              <div className="mt-4">
                <InputLabel htmlFor="task_code" value="Codice Lavorazione" />
