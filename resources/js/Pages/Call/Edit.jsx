...
export default function Edit({ auth, call }) {
  const { data, setData, put, errors, reset } = useForm({
    oggetto: call.oggetto || "",
    note: call.note || "",
    tipo: call.tipo || "",
    urgenza: call.urgenza || "",
    note2: call.note2 || "",
    cliente: call.cliente || "",
    data: call.data || "",
    stato: call.stato || "",
    modulo: call.modulo || "",
    cantiere: call.cantiere || "",
    work_id: call.work_id || "",
    work_name: call.work_name || "",
