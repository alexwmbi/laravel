...
export default function Edit({ auth, supplier}) {
  const { data, setData, put, errors, reset } = useForm({
   ...
   cfcditta: supplier.cfcditta || "", tipocf: supplier.tipocf || "", codcf: supplier.codcf || "", ragsoccf: supplier.ragsoccf || "", domicilio: supplier.domicilio || "",capcf: supplier.capcf || "",cittacf: supplier.cittacf || "",provcf: supplier.provcf || "",codfis: supplier.codfis || "",pivacf: supplier.pivacf || "",telef: supplier.telef || "",fax: supplier.fax || "",addbol: supplier.addbol || "",codban: supplier.codban || "",sconto1: supplier.sconto1 || "",sconto2: supplier.sconto2 || "",sconto3: supplier.sconto3 || "",codpag: supplier.codpag || "",codese: supplier.codese || "",codliscf: supplier.codliscf || "",civacf: supplier.civacf || "",speinc: supplier.speinc || "",speince: supplier.speince || "",cognome: supplier.cognome || "",nome: supplier.nome || "",perfis: supplier.perfis || "",sesso: supplier.sesso || "",datanas: supplier.datanas || "",provnas: supplier.provnas || "",codcon: supplier.codcon || "",partite: supplier.partite || "",scadenze: supplier.scadenze || "",mese2es: supplier.mese2es || "",giornosc: supplier.giornosc || "",numaut: supplier.numaut || "",dataaut: supplier.dataaut || "",numpro: supplier.numpro || "",tipocli: supplier.tipocli || "",ragsocfa: supplier.ragsocfa || "",indirifa: supplier.indirifa || "",cittafa: supplier.cittafa || "",provfa: supplier.provfa || "",capfa: supplier.capfa || "",ragsocri: supplier.ragsocri || "",indiriri: supplier.indiriri || "",cittari: supplier.cittari || "",provri: supplier.provri || "",capri: supplier.capri || "",fatemail: supplier.fatemail || "",indemailf: supplier.indemailf || "",indemaile: supplier.indemaile || "",indemailo: supplier.indemailo || "",indemailp: supplier.indemailp || "",indemailg: supplier.indemailg || "",perrit: supplier.perrit || "",cfcodiban: supplier.cfcodiban || "",numdoc: supplier.numdoc || "",flagraee: supplier.flagraee || "",tipoca: supplier.tipoca || "",flagra: supplier.flagra || "",cccodtri: supplier.cccodtri || "",indpec: supplier.indpec || "",
  });
      ...
      header={
        <div className="flex justify-between items-center">
          <h2 className="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            Modifica Fornitore "{supplier.ragsoccf}"
          </h2>
        </div>
      }
    >
      <Head title="Fornitori" />
      {/* <pre>{JSON.stringify(supplier,undefined, 2)}</pre>  */}
      <div className="py-12">
